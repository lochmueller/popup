...
class tx_popup_pi1 extends tslib_pibase {
	...
	function main($content,$conf)	{
		...
		while (list($key,$val) = each($params)) {
			if (isset($val) && $val!='')	$tmp_params[] = $key.'='.$val;
		}
...
if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/popup/pi1/class.tx_popup_pi1.php"])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/popup/pi1/class.tx_popup_pi1.php"]);
} # if
