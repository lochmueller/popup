...
class ux_tslib_gmenu_layers extends tslib_gmenu_foldout {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/popup/xclasses/class.ux_tslib_gmenu_layers.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/popup/xclasses/class.ux_tslib_gmenu_layers.php']);
}
?>
